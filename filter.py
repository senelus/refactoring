...
while current_width < width - 9:
    ...
    while current_height < height - 9:
        ...
        for n in range(current_width, current_width + 10):
            for first_component in range(current_height, current_height + 10):
                image_array[n][first_component][0] = int(total_brightness // 50) * 50
                image_array[n][first_component][1] = int(total_brightness // 50) * 50
                image_array[n][first_component][2] = int(total_brightness // 50) * 50
